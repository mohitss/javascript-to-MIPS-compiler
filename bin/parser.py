...
def p_iterationStatement(p):
	...
	if p[1] == "while":
	...
	elif p[1]=="for" and p[2] == "(" and p[3] == ";" and p[4] == ";" and p[6] == ")" :
		p[0]["code"] += [["label","before_for_"+while_label]]
		p[0]["code"] += p[7]["code"]
		p[0]["code"] += p[5]["code"]
		p[0]["code"] += [["goto","before_for_"+while_label]]
		p[0]["code"] += [["label","after_for_"+while_label]]
	elif p[1]=="for" and p[2] == "(" and p[3] == ";" and p[5] == ";" and p[6] == ")" :
		p[0]["code"] += [["label","before_for_"+while_label]]
		p[0]["code"] += p[4]["code"]
		p[0]["code"] += [["ifgoto","beq",p[4]["place"],0,"truth"+while_label]]
		p[0]["code"] += [["goto","after_for_"+while_label]]	
		p[0]["code"] += [["label","truth"+while_label]]	
		p[0]["code"] += p[7]["code"]
		p[0]["code"] += [["goto","before_for_"+while_label]]
		p[0]["code"] += [["label","after_for_"+while_label]]
	elif p[1]=="for" and p[2] == "(" and p[3] == ";" and p[5] == ";" and p[7] == ")" :
		p[0]["code"] += [["label","before_for_"+while_label]]
		p[0]["code"] += p[4]["code"]
		p[0]["code"] += [["ifgoto","beq",p[4]["place"],0,"truth"+while_label]]
		p[0]["code"] += [["goto","after_for_"+while_label]]	
		...
		p[0]["code"] += [["goto","before_for_"+while_label]]
		p[0]["code"] += [["label","after_for_"+while_label]]
	elif p[1]=="for" and p[2] == "(" and p[5] == ";" and p[6] == ";" and p[7] == ")" :
		p[0]["code"] += p[4]["code"]
		p[0]["code"] += [["label","before_for_"+while_label]]
		p[0]["code"] += [["label","truth"+while_label]]	
		p[0]["code"] += p[8]["code"]
		p[0]["code"] += [["goto","before_for_"+while_label]]
		p[0]["code"] += [["label","after_for_"+while_label]]
	elif p[1]=="for" and p[2] == "(" and p[5] == ";" and p[6] == ";" and p[8] == ")" :
		p[0]["code"] += p[4]["code"]
		p[0]["code"] += [["label","before_for_"+while_label]]
		p[0]["code"] += [["label","truth"+while_label]]	
		p[0]["code"] += p[9]["code"]
		...
		p[0]["code"] += [["goto","before_for_"+while_label]]
		p[0]["code"] += [["label","after_for_"+while_label]]
	elif p[1]=="for" and p[2] == "(" and p[5] == ";" and p[7] == ";" and p[8] == ")" :
		p[0]["code"] += p[4]["code"]
		p[0]["code"] += [["label","before_for_"+while_label]]
		p[0]["code"] += p[6]["code"]
		p[0]["code"] += [["ifgoto","beq",p[6]["place"],0,"truth"+while_label]]
		p[0]["code"] += [["goto","after_for_"+while_label]]	
		p[0]["code"] += [["label","truth"+while_label]]	
		p[0]["code"] += p[9]["code"]
		p[0]["code"] += [["goto","before_for_"+while_label]]
		p[0]["code"] += [["label","after_for_"+while_label]]
	elif p[1]=="for" and p[2] == "(" and p[5] == ";" and p[7] == ";" and p[9] == ")" :
		p[0]["code"] += p[4]["code"]
		p[0]["code"] += [["label","before_for_"+while_label]]
		p[0]["code"] += p[6]["code"]
		p[0]["code"] += [["ifgoto","beq",p[6]["place"],0,"truth"+while_label]]
		...
		p[0]["code"] += [["goto","before_for_"+while_label]]
		p[0]["code"] += [["label","after_for_"+while_label]]
	elif p[1]=="for" and p[2] == "(" and p[4] == ";" and p[5] == ";" and p[6] == ")" :
		p[0]["code"] += p[3]["code"]
		p[0]["code"] += [["label","before_for_"+while_label]]
		p[0]["code"] += [["label","truth"+while_label]]	
		p[0]["code"] += p[7]["code"]
		p[0]["code"] += [["goto","before_for_"+while_label]]
		p[0]["code"] += [["label","after_for_"+while_label]]
	elif p[1]=="for" and p[2] == "(" and p[4] == ";" and p[5] == ";" and p[7] == ")" :
		p[0]["code"] += p[3]["code"]
		p[0]["code"] += [["label","before_for_"+while_label]]
		p[0]["code"] += [["label","truth"+while_label]]	
		p[0]["code"] += p[8]["code"]
		...
		p[0]["code"] += [["goto","before_for_"+while_label]]
		p[0]["code"] += [["label","after_for_"+while_label]]
	elif p[1]=="for" and p[2] == "(" and p[4] == ";" and p[6] == ";" and p[7] == ")" :
		p[0]["code"] += p[3]["code"]
		p[0]["code"] += [["label","before_for_"+while_label]]
		p[0]["code"] += p[5]["code"]
		...
		p[0]["code"] += [["goto","before_for_"+while_label]]
		p[0]["code"] += [["label","after_for_"+while_label]]
	elif p[1]=="for" and p[2] == "(" and p[4] == ";" and p[6] == ";" and p[8] == ")" :
		p[0]["code"] += p[3]["code"]
		p[0]["code"] += [["label","before_for_"+while_label]]
		p[0]["code"] += p[5]["code"]
		p[0]["code"] += [["ifgoto","beq",p[5]["place"],0,"truth"+while_label]]
